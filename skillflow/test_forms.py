...
class SignUpFormTests(TestCase):
    ...
    def test_signup_form_invalid_data(self):
        ...
        self.assertIn('password2', form.errors) # Ensures error is related to password mismatch
...
class ServiceFormTests(TestCase):
    ...
    def test_service_form_invalid_hourly_rate(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertIn('hourly_rate', form.errors) # Confirms error is related to hourly rate
